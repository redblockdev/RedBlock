...
* redblock.conf: contains configuration settings for redblockd or redblock-qt
* redblockd.pid: stores the process id of redblockd while running
...
* debug.log: contains debug information and general logging generated by redblockd or redblock-qt
