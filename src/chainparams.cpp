...
{
    const char* pszTimestamp = "BBC News 20/Oct/2018 US Mega Millions lottery jackpot hits record $1.6bn";//BSHa3d genesis block used out of respect for the project, forked at block 1 for new chain.
