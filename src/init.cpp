 ...
 * between redblockd, and redblock-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/redblockdev/redblock>";
    const std::string URL_WEBSITE = "<https://redblockcoin.com>";
